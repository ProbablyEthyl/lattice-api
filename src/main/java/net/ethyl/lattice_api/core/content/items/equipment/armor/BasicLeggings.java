...
import net.ethyl.lattice_api.modules.common.items.equipment.armor.LatticeBasicLeggings;
...
public class BasicLeggings extends ArmorItem {
    private final boolean hasDescription;

    public BasicLeggings(@NotNull LatticeBasicLeggings.AppendableBuilder<? extends LatticeItem<BasicLeggings>, ?> builder) {
        super(builder.getArmorMaterial(), Type.LEGGINGS, builder.getItemProperties());
