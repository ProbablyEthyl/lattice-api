...
public class LatticeItem<T extends Item> extends LatticeObject {
    ...
    protected LatticeItem(@NotNull RegistryId registryId, @NotNull DeferredItem<T> deferredItem, @NotNull Builder<T, ? extends LatticeItem<T>, ?> builder) {
        super(registryId);
    ...
    public static class Builder<T extends Item, I extends LatticeItem<T>, B extends Builder<T, I, B>> {
        private final TriFunction<RegistryId, DeferredItem<T>, B, I> latticeFactory;
        private final Function<B, T> itemFactory;
        protected LatticeItemModelType modelType = LatticeRegistries.ModelTypes.Item.BASIC;
        ...
        protected Builder(@NotNull TriFunction<RegistryId, DeferredItem<T>, B, I> latticeFactory, @NotNull Function<B, T> itemFactory) {
